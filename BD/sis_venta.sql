...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2022 a las 08:42:01
...
SELECT COUNT(*) INTO categorias FROM categoria;

SELECT COUNT(*) INTO ventas FROM factura WHERE fecha > CURDATE();

SELECT usuarios, clientes, proveedores, productos, ventas, categorias;
...
(1, 2580, 'Compulab', 'Compulab', 925491523, 'yefer@compulab.com', 'popayàn- Cauca', '1.18');
...
(1, 'Compulab', 'compulab@gmail.com', 'admin', '827ccb0eea8a706c4c34a16891f84e7b', 1, 1),
(6, 'Maria Perez Miranda', 'yefer@gmail.com', 'yefer', '827ccb0eea8a706c4c34a16891f84e7b', 2, 1);
