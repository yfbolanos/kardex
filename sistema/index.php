...
<div class="container-fluid">
	...
	<div class="row">
		...
		<a class="col-xl-3 col-md-6 mb-4" href="lista_cliente.php">
			<div class="card border-left-success shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-success text-uppercase mb-1">Sedes</div>
		...
		<a class="col-xl-3 col-md-6 mb-4" href="lista_categoria.php">
			<div class="card border-left-primary shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Categorias</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data['categorias']; ?></div>
						</div>
						<div class="col-auto">
							<i class="fas fa-user fa-2x text-gray-300"></i>
						</div>
		...
		<a class="col-xl-3 col-md-6 mb-4" href="lista_proveedor.php">
			<div class="card border-left-primary shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Provedores</div>
							<div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data['proveedores']; ?></div>
						</div>
						<div class="col-auto">
							<i class="fas fa-user fa-2x text-gray-300"></i>
						</div>
				...
				<div class="card-body">
					...
					<ul class="list-group">
						...
						<form action="" method=" post" name="frmChangePass" id="frmChangePass" class="p-3">
							...
							<div>
								<button type="submit" class="btn btn-danger btnChangePass">Cambiar Contraseña</button>
							</div>
						</form>
					</ul>
				</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
							...
							<div>
								<button type="submit" class="btn btn-danger btnChangePass"><i class="fas fa-save"></i> Guardar Datos</button>
							</div>
