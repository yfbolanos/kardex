...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				<!-- Topbar -->
				<nav class="menu navbar navbar-expand navbar-light bg-primary text-white topbar mb-4 static-top shadow">
					...
					<div class="input-group">
						<h4><strong>KARDEX</strong></h4>
						<p class="ml-auto"><strong>Cauca - Popayan, </strong><?php echo fechaPeru(); ?></p>
					</div>
