...
if (!empty($_POST)) {
  ...
  if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
    ...
    if ($resul >= 1) {
      ...
      if ($sql_update) {
        $alert = '<p class="alert alert-success" role="alert">Sede Actualizada correctamente</p>';
      } else {
        $alert = '<p class="alert alert-danger" role="alert">Error al Actualizar la Sede</p>';
      }
    }
  }
}
            ...
            <div class="col-lg-6 m-auto">
              ...
              <form class="" action="" method="post">
                ...
                <div class="form-group">
                  <label for="dni">Codigo SGSSS</label>
